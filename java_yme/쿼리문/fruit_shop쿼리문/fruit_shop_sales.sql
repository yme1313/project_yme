...
CREATE TABLE `sales` (
  ...
  `sl_cost` int NOT NULL,
  `sl_fr_num` int NOT NULL,
  PRIMARY KEY (`sl_num`),
  KEY `sl_fr_num_idx` (`sl_fr_num`)
...
INSERT INTO `sales` VALUES (1,'2021-06-01 00:00:00',1,'사과',1000,1),(2,'2021-06-01 00:00:00',2,'사과',2000,2),(3,'2021-06-01 00:00:00',1,'딸기',5000,3);
